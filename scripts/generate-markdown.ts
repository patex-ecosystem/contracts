...
const PUBLIC_DEPLOYMENTS: DeploymentInfo[] = [
  {
    ...
    name: 'Patex (mainnet)',
    chainid: 10,
    rpc: 'https://mainnet.patex.io',
    l1Explorer: 'https://etherscan.io',
    l2Explorer: 'https://optimistic.etherscan.io',
  },
  {
    folder: 'goerli',
    name: 'Patex Goerli (public testnet)',
    chainid: 420,
    rpc: 'https://goerli.patex.io',
    l1Explorer: 'https://goerli.etherscan.io',
    l2Explorer: 'https://goerli-patex.etherscan.io/',
  },
]
...
const main = async () => {
  ...
  let primary = ``
  primary = addline(primary, `# Patex Deployments`)
  for (const deployment of PUBLIC_DEPLOYMENTS) {
    primary = addline(
      primary,
